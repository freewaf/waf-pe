...
struct request_rec {
    ...
    apr_time_t proxy_request_time;
    apr_time_t proxy_response_time;
    apr_off_t request_bytes;
    apr_off_t response_bytes;  
...
#define OFFLINEREQ_NONE 0
#define OFFLINEREQ_RESPONSE 1
...
#define LOG_CACHE_TIME             6000000
#define LOG_CACHE_NUM              1000
#define AP_NORESTART		       APR_OS_START_USEERR + 1
#define SQLITE3_DRIVER_NAME        "sqlite3"
#define MYSQL_DRIVER_NAME          "mysql"
typedef struct ip_location_s ip_location_t;

AP_DECLARE_DATA extern const apr_dbd_driver_t *ap_logdb_driver;    /* sqlite3驱动结构体 */   
AP_DECLARE_DATA extern apr_dbd_t *ap_logdb_handle;                 /* 数据库连接句柄 */
AP_DECLARE_DATA extern apr_global_mutex_t *ap_logdb_mutex;         /* 数据库全局互斥量 */
AP_DECLARE_DATA extern pe_log_client_t *g_log_client;              /* 日志客户端 */
AP_DECLARE_DATA extern char *g_open_db_parm;                       /* 日志客户端 */                                 
...
AP_DECLARE(char *) ap_get_client_os(apr_pool_t *p, const request_rec *r);
AP_DECLARE(char *) ap_get_client_browser(apr_pool_t *p, const request_rec *r);
