...
* the License. 聽You may obtain a copy of the License at
*
* 聽 聽 http://www.apache.org/licenses/LICENSE-2.0
*
...
#define ACTION_TIME_STRING_LEN   35
#define EXPIRECOOKIE_MAX_TIMEOUT 129600  /* 单位(分钟)，最大超时时间为3个月 */
#define MINUTE_TO_USEC(minute)   (((apr_time_t)(minute) * 60) * 1000000)
