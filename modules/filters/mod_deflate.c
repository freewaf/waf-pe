...
static const char inflateFilterName[] = "INFLATE";
...
static void deflate_hook_insert_filter(request_rec *r)
{
    /* 解压缩请求体 */
    ap_add_input_filter(deflateFilterName, NULL, r, r->connection);
    /* 解压缩响应体 */
    ap_add_output_filter(inflateFilterName, NULL, r, r->connection);
    /* 压缩响应体 */
...
{
    ap_hook_insert_filter(deflate_hook_insert_filter, NULL, NULL, APR_HOOK_FIRST);
    ap_register_output_filter(deflateFilterName, deflate_out_filter, NULL,
                              AP_FTYPE_CONTENT_SET+1);
    ap_register_output_filter(inflateFilterName, inflate_out_filter, NULL,
                              AP_FTYPE_RESOURCE-1);
